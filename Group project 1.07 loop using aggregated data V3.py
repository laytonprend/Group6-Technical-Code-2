...
File=File.drop(columns=['flesch_kincaid_Count','smog_Count'])
#File['ChildCount']
#mean create
...
#temp=File['length_Mean'].loc[File['length_Mean']==File['length_Mean2']]
                      
#h=File['length_Mean']
#print('is length mean accurate'+str(temp.count() / File['length_Mean'].count()))
#    men=heart_df['sex'].loc[heart_df['sex']==1.0]
#women=heart_df['sex'].loc[heart_df['sex']==0.0]
#print(100*men.count()/(women.count()+men.count())+'%')
